...
function Graph({ rows, lanes }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { className: "dgp-graph", width: lanes * LANE_WIDTH + 6, height: ROW_HEIGHT, "aria-hidden": true, children: [
    rows.map(
